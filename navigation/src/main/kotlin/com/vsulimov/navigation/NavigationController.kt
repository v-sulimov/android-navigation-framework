...
class NavigationController<Screen : NavigationComponent, Overlay : NavigationComponent>(
     ...
     */
    private fun updateScreen(screenState: Screen, transitionType: TransitionType) {
        val currentScreenTypeId = fragmentManager.findFragmentByTag(TAG_SCREEN)?.let {
     ...
     */
    private fun replaceScreenFragment(screenState: Screen, newScreenTypeId: String, transitionType: TransitionType) {
     ...
     */
    private fun setupScreenTransitionAnimations(transaction: FragmentTransaction, transitionType: TransitionType) {
     ...
     */
    private fun replaceOverlayIfNecessary(currentOverlay: DialogFragment, overlayState: Overlay) {
